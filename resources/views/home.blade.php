                ...
                <div class="card w-100 h-100 ">
                    ...
                    <div class="card-body h-100">
                        <div class="row h-100">
                            ...
                            <div class="col-8">
                                <div class="card bg-secondary text-light profile-card rtl ">
                                    <div class="card-header ">
                                        <h3> {{__("dashboard.UserProfile")}}</h3>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text"><strong> {{__("strings.Name")}} :
                                            </strong>{{\Illuminate\Support\Facades\Auth::user()->name}}
                                        </p>
                                        <p class="card-text"><strong> {{__("strings.Email")}} :
