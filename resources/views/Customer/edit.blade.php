            ...
            <div class="col-8">
                <div class="card mt-5 mb-5">
                    <div class="card-header bg-dark text-light">
                        @lang('strings.Customer.edit.cardTitle')
                    </div>
                    <div class="card-body p-4">
                        <form class="form" method="post" action={{route('Customer.update' , $customer)}}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$customer['father-name']}}" class="form-control" id="father-name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="string" value="{{$customer->phone_number}}" class="form-control"
                                       id="phone_number"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{$customer->national_code}}" class="form-control"
                                       id="national_code"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" value="{{$customer->birth_date}}" id="birth_date"
                                       name="birth_date"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $customer->post_code }}" class="form-control" id="post_code"
                                       name="post_code"
